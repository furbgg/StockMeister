...
const StaffPage = () => {
    ...
    const getRoleBadgeColor = () => {
        return 'bg-blue-50 text-[#16213e] border-blue-100';
    };
                    ...
                    <div className="relative flex items-center gap-2 w-full sm:w-auto">
                        ...
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                <Button variant="outline" className="bg-white/60 backdrop-blur-sm border-slate-200 hover:bg-white transition-all text-slate-600">
                            ...
                            <Table>
                                <TableHeader className="sticky top-0 z-10 bg-white/40 backdrop-blur-sm border-b border-purple-100/20">
                                    <TableRow className="hover:bg-transparent border-none">
                                        <TableHead className="w-[80px] pl-6 font-semibold text-[#16213e]">ID</TableHead>
                                        <TableHead className="font-semibold text-[#16213e]">{t('staff.username')}</TableHead>
                                        <TableHead className="font-semibold text-[#16213e]">{t('staff.email')} / {t('staff.phone')}</TableHead>
                                        <TableHead className="font-semibold text-[#16213e]">{t('staff.salary')}</TableHead>
                                        <TableHead className="font-semibold text-[#16213e]">{t('staff.schedule')}</TableHead>
                                        <TableHead className="text-right pr-6 font-semibold text-[#16213e]">{t('common.actions')}</TableHead>
                                    </TableRow>
                                </TableHeader>
                                <TableBody>
                                    {loading ? (
                                        ...
                                        processedUsers.map((user) => (
                                            <TableRow key={user.id} className="group hover:bg-slate-50/50 transition-colors border-b border-slate-100">
