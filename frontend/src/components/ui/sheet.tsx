  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        style={{ backgroundColor: "rgba(124, 49, 118, 0.6)" }}
        className={cn(
          "fixed z-50 gap-4 p-6 shadow-2xl transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out backdrop-blur-md text-white border-none",
          side === "right" &&
