...
export const PageHeader = ({ title, description, children, className }: PageHeaderProps) => {
    return (
        <div className={cn(
            "relative bg-purple-50 rounded-xl p-6 shadow-sm border border-purple-100 transition-all duration-700 overflow-hidden mb-6",
            className
        )}>
            ...
            <div className="relative z-10 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div className="relative group">
                        ...
                        <div className="relative flex h-12 w-12 min-w-12 items-center justify-center rounded-2xl bg-white shadow-sm ring-1 ring-purple-100 group-hover:scale-105 transition-transform duration-500">
